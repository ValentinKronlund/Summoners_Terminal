        ...
        while (champion == null) {
            ...
            switch (championRequest) {
                case "Garen", "garen", "G", "g": {
                    ...
                    champion.setPassive(passiveFactory.Create(Factory.ePassive.THE_ROCK, champion));
                    break;
                }
                case "Katarina", "katarina", "K", "k": {
                    champion = ChampionID.KATARINA.create(playerName);
                    champion.setPassive(passiveFactory.Create(Factory.ePassive.Mundo_Does_What_He_Pleased, champion));
                    break;
                }
                case "Veigar", "veigar", "V", "v": {
                    champion = ChampionID.VEIGAR.create(playerName);
                    champion.setPassive(passiveFactory.Create(Factory.ePassive.INFINITE_POWER, champion));
                    break;
                }
                default: {
